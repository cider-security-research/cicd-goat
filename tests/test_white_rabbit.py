...
from conftest import REPOSITORIES_DIR, GITEA_GIT_BASE
from utils import branch_and_replace_file_content, find_in_console


def test_white_rabbit(gitea_client, jenkins_client):
    repo = Repo.clone_from(f'{GITEA_GIT_BASE}/Wonderland/white-rabbit.git',
    ...
    res = gitea_client.post('/repos/Wonderland/white-rabbit/pulls',
